...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConfiguredLeaderboard")]
    public partial class ConfiguredLeaderboard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfiguredLeaderboard" /> class.
        /// </summary>
        /// <param name="individual">individual.</param>
        /// <param name="team">team.</param>
        /// <param name="weekly">weekly.</param>
        public ConfiguredLeaderboard(List<LeaderboardEntry> individual = default(List<LeaderboardEntry>), List<LeaderboardEntry> team = default(List<LeaderboardEntry>), List<LeaderboardEntry> weekly = default(List<LeaderboardEntry>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfiguredLeaderboard {\n");
