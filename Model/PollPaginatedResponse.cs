...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PollPaginatedResponse")]
    public partial class PollPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PollPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PollPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PollPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public PollPaginatedResponse(List<Poll> data = default(List<Poll>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PollPaginatedResponse {\n");
