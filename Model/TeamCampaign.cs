...
namespace TiltifyV5.Model
{
    ...
    /// TeamCampaign
    /// </summary>
    [DataContract(Name = "TeamCampaign")]
    public partial class TeamCampaign : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The amount raised by this campaign and all supporting campaigns</value>
        [DataMember(Name = "supportable", IsRequired = true, EmitDefaultValue = true)]
        public SupportableEnum Supportable { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaign" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamCampaign() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaign" /> class.
        /// </summary>
        ...
        /// <param name="description">A short description about this team campaign (required).</param>
        ...
        /// <param name="insertedAt">When the team campaign was created (required).</param>
        ...
        /// <param name="name">The name of this team campaign (required).</param>
        /// <param name="originalGoal">originalGoal (required).</param>
        /// <param name="publishedAt">When the team campaign was last published (required).</param>
        /// <param name="retiredAt">When the team campaign was retired (required).</param>
        ...
        /// <param name="supportable">The amount raised by this campaign and all supporting campaigns (required).</param>
        /// <param name="supportingAmountRaised">supportingAmountRaised (required).</param>
        /// <param name="team">team (required).</param>
        /// <param name="teamId">Unique Identifier for the Object. UUID (required).</param>
        /// <param name="totalAmountRaised">totalAmountRaised (required).</param>
        /// <param name="updatedAt">When the team campaign details were last updated (required).</param>
        /// <param name="url">This is the full url used for the given resource. (required).</param>
        public TeamCampaign(Money amountRaised = default(Money), Image avatar = default(Image), string currencyCode = default(string), string description = default(string), string donateUrl = default(string), TeamCampaignGoal goal = default(TeamCampaignGoal), bool hasSchedule = default(bool), Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), CampaignLivestream livestream = default(CampaignLivestream), string name = default(string), Money originalGoal = default(Money), DateTime publishedAt = default(DateTime), DateTime? retiredAt = default(DateTime?), string slug = default(string), StatusEnum status = default(StatusEnum), SupportableEnum supportable = default(SupportableEnum), Money supportingAmountRaised = default(Money), TeamCampaignTeam team = default(TeamCampaignTeam), Guid teamId = default(Guid), Money totalAmountRaised = default(Money), DateTime updatedAt = default(DateTime), string url = default(string))
        {
            // to ensure "amountRaised" is required (not null)
            if (amountRaised == null)
            {
                throw new ArgumentNullException("amountRaised is a required property for TeamCampaign and cannot be null");
            }
            this.AmountRaised = amountRaised;
            // to ensure "avatar" is required (not null)
            if (avatar == null)
            {
                throw new ArgumentNullException("avatar is a required property for TeamCampaign and cannot be null");
            }
            this.Avatar = avatar;
            // to ensure "currencyCode" is required (not null)
            if (currencyCode == null)
            {
                throw new ArgumentNullException("currencyCode is a required property for TeamCampaign and cannot be null");
            }
            this.CurrencyCode = currencyCode;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TeamCampaign and cannot be null");
            }
            this.Description = description;
            // to ensure "donateUrl" is required (not null)
            if (donateUrl == null)
            {
                throw new ArgumentNullException("donateUrl is a required property for TeamCampaign and cannot be null");
            }
            this.DonateUrl = donateUrl;
            // to ensure "goal" is required (not null)
            if (goal == null)
            {
                throw new ArgumentNullException("goal is a required property for TeamCampaign and cannot be null");
            }
            this.Goal = goal;
            ...
            if (livestream == null)
            {
                throw new ArgumentNullException("livestream is a required property for TeamCampaign and cannot be null");
            }
            this.Livestream = livestream;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TeamCampaign and cannot be null");
            }
            this.Name = name;
            // to ensure "originalGoal" is required (not null)
            if (originalGoal == null)
            {
                throw new ArgumentNullException("originalGoal is a required property for TeamCampaign and cannot be null");
            }
            ...
            if (retiredAt == null)
            {
                throw new ArgumentNullException("retiredAt is a required property for TeamCampaign and cannot be null");
            }
            this.RetiredAt = retiredAt;
            // to ensure "slug" is required (not null)
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for TeamCampaign and cannot be null");
            }
            this.Slug = slug;
            this.Status = status;
            this.Supportable = supportable;
            // to ensure "supportingAmountRaised" is required (not null)
            if (supportingAmountRaised == null)
            {
                throw new ArgumentNullException("supportingAmountRaised is a required property for TeamCampaign and cannot be null");
            }
            this.SupportingAmountRaised = supportingAmountRaised;
            // to ensure "team" is required (not null)
            if (team == null)
            {
                throw new ArgumentNullException("team is a required property for TeamCampaign and cannot be null");
            }
            this.Team = team;
            this.TeamId = teamId;
            ...
            {
                throw new ArgumentNullException("totalAmountRaised is a required property for TeamCampaign and cannot be null");
            }
            ...
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for TeamCampaign and cannot be null");
            }
            this.Url = url;
        }
        ...
        /// </summary>
        /// <value>A short description about this team campaign</value>
        ...
        public TeamCampaignGoal Goal { get; set; }
        ...
        /// </summary>
        /// <value>When the team campaign was created</value>
        ...
        /// </summary>
        /// <value>The name of this team campaign</value>
        ...
        /// </summary>
        /// <value>When the team campaign was last published</value>
        ...
        /// </summary>
        /// <value>When the team campaign was retired</value>
        ...
        /// <summary>
        /// Gets or Sets SupportingAmountRaised
        /// </summary>
        [DataMember(Name = "supporting_amount_raised", IsRequired = true, EmitDefaultValue = true)]
        ...
        public TeamCampaignTeam Team { get; set; }
        ...
        /// </summary>
        /// <value>When the team campaign details were last updated</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Supportable: ").Append(Supportable).Append("\n");
            sb.Append("  SupportingAmountRaised: ").Append(SupportingAmountRaised).Append("\n");
