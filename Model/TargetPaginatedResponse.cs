...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TargetPaginatedResponse")]
    public partial class TargetPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TargetPaginatedResponse(List<Target> data = default(List<Target>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetPaginatedResponse {\n");
