...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DonationMatchPaginatedResponse")]
    public partial class DonationMatchPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationMatchPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DonationMatchPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationMatchPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public DonationMatchPaginatedResponse(List<DonationMatch> data = default(List<DonationMatch>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DonationMatchPaginatedResponse {\n");
