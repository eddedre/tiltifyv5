...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCampaignPaginatedResponse")]
    public partial class TeamCampaignPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamCampaignPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TeamCampaignPaginatedResponse(List<TeamCampaign> data = default(List<TeamCampaign>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCampaignPaginatedResponse {\n");
