...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EventPaginatedResponse")]
    public partial class EventPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public EventPaginatedResponse(List<Event> data = default(List<Event>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventPaginatedResponse {\n");
