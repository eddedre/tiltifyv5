...
namespace TiltifyV5.Model
{
    ...
    public partial class Target : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Target" /> class.
        /// </summary>
        /// <param name="active">Whether or not the target is active (required).</param>
        /// <param name="amount">amount (required).</param>
        /// <param name="amountRaised">amountRaised (required).</param>
        /// <param name="endsAt">Moment when the target ends (required).</param>
        /// <param name="id">Unique Identifier for the Object. UUID (required).</param>
        /// <param name="insertedAt">Moment when the target was created (required).</param>
        ...
        /// <param name="updatedAt">Moment when the target was last updated (required).</param>
        public Target(bool active = default(bool), Money amount = default(Money), Money amountRaised = default(Money), DateTime endsAt = default(DateTime), Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), string name = default(string), DateTime updatedAt = default(DateTime))
        {
            this.Active = active;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for Target and cannot be null");
            }
            this.Amount = amount;
            // to ensure "amountRaised" is required (not null)
            if (amountRaised == null)
            {
                throw new ArgumentNullException("amountRaised is a required property for Target and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Whether or not the target is active</value>
        ...
        /// </summary>
        /// <value>Moment when the target ends</value>
        ...
        /// </summary>
        /// <value>Moment when the target was created</value>
        ...
        /// </summary>
        /// <value>Moment when the target was last updated</value>
