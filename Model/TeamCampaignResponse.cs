...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCampaignResponse")]
    public partial class TeamCampaignResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TeamCampaignResponse(TeamCampaign data = default(TeamCampaign))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCampaignResponse {\n");
