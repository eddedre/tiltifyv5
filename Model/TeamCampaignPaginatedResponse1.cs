...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCampaignPaginatedResponse_1")]
    public partial class TeamCampaignPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamCampaignPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TeamCampaignPaginatedResponse1(List<TeamCampaign> data = default(List<TeamCampaign>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public List<TeamCampaign> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCampaignPaginatedResponse1 {\n");
