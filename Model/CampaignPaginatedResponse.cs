...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignPaginatedResponse")]
    public partial class CampaignPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public CampaignPaginatedResponse(List<Campaign> data = default(List<Campaign>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignPaginatedResponse {\n");
