...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MeasuredUnit")]
    public partial class MeasuredUnit : IValidatableObject
    {
        /// <summary>
        /// measured unit
        /// </summary>
        /// <value>measured unit</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasuredUnit" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MeasuredUnit() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasuredUnit" /> class.
        /// </summary>
        /// <param name="unit">measured unit (required).</param>
        /// <param name="value">Monetary amount (required).</param>
        public MeasuredUnit(UnitEnum unit = default(UnitEnum), string value = default(string))
        {
            this.Unit = unit;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for MeasuredUnit and cannot be null");
            }
            this.Value = value;
        }
