...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TargetPaginatedResponse_1")]
    public partial class TargetPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TargetPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TargetPaginatedResponse1(List<Target> data = default(List<Target>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public List<Target> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TargetPaginatedResponse1 {\n");
