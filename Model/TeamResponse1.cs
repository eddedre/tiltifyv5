...
namespace TiltifyV5.Model
{
    ...
    /// TeamResponse1
    /// </summary>
    [DataContract(Name = "TeamResponse_1")]
    public partial class TeamResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TeamResponse1(Team data = default(Team))
        {
            this.Data = data;
        }
