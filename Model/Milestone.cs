...
namespace TiltifyV5.Model
{
    ...
    public partial class Milestone : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Milestone" /> class.
        /// </summary>
        /// <param name="active">Whether or not the milestone is active (required).</param>
        ...
        public Milestone(bool active = default(bool), Money amount = default(Money), Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), string name = default(string), DateTime updatedAt = default(DateTime))
        {
            this.Active = active;
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for Milestone and cannot be null");
            }
            this.Amount = amount;
            this.Id = id;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Milestone and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Whether or not the milestone is active</value>
