...
namespace TiltifyV5.Model
{
    ...
    public partial class Image : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Image" /> class.
        /// </summary>
        /// <param name="alt">Short description of the image (required).</param>
        /// <param name="height">Height of the image. (required).</param>
        /// <param name="src">Full URL of the image. (required).</param>
        /// <param name="width">Width of the image. (required).</param>
        public Image(string alt = default(string), int? height = default(int?), string src = default(string), int? width = default(int?))
        {
            // to ensure "alt" is required (not null)
            if (alt == null)
            {
                throw new ArgumentNullException("alt is a required property for Image and cannot be null");
            }
            this.Alt = alt;
            // to ensure "height" is required (not null)
            if (height == null)
            {
                throw new ArgumentNullException("height is a required property for Image and cannot be null");
            }
            this.Height = height;
            // to ensure "src" is required (not null)
            if (src == null)
            {
                throw new ArgumentNullException("src is a required property for Image and cannot be null");
            }
            this.Src = src;
            // to ensure "width" is required (not null)
            if (width == null)
            {
                throw new ArgumentNullException("width is a required property for Image and cannot be null");
            }
            this.Width = width;
        }
        ...
        /// </summary>
        /// <value>Short description of the image</value>
        ...
        /// </summary>
        /// <value>Full URL of the image.</value>
