...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MilestonePaginatedResponse")]
    public partial class MilestonePaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilestonePaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MilestonePaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MilestonePaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public MilestonePaginatedResponse(List<Milestone> data = default(List<Milestone>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilestonePaginatedResponse {\n");
