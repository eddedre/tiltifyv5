...
{
    /// <summary>
    /// LeaderboardEntryPaginatedResponse1Metadata
    /// </summary>
    [DataContract(Name = "LeaderboardEntryPaginatedResponse_1_metadata")]
    public partial class LeaderboardEntryPaginatedResponse1Metadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryPaginatedResponse1Metadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LeaderboardEntryPaginatedResponse1Metadata() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryPaginatedResponse1Metadata" /> class.
        /// </summary>
        /// <param name="after">The cursor to the next page if it exists (required).</param>
        /// <param name="before">The cursor to the previous page if it exists (required).</param>
        /// <param name="limit">The requested record limit (required).</param>
        public LeaderboardEntryPaginatedResponse1Metadata(string after = default(string), string before = default(string), decimal limit = default(decimal))
        {
            // to ensure "after" is required (not null)
            if (after == null)
            {
                throw new ArgumentNullException("after is a required property for LeaderboardEntryPaginatedResponse1Metadata and cannot be null");
            }
            this.After = after;
            // to ensure "before" is required (not null)
            if (before == null)
            {
                throw new ArgumentNullException("before is a required property for LeaderboardEntryPaginatedResponse1Metadata and cannot be null");
            }
            this.Before = before;
            this.Limit = limit;
        }
        ...
        /// </summary>
        /// <value>The cursor to the next page if it exists</value>
        ...
        /// </summary>
        /// <value>The cursor to the previous page if it exists</value>
        ...
        /// </summary>
        /// <value>The requested record limit</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardEntryPaginatedResponse1Metadata {\n");
