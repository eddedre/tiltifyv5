...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Campaign_user")]
    public partial class CampaignUser : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignUser" /> class.
        /// </summary>
        ...
        public CampaignUser(Image avatar = default(Image), string description = default(string), Guid id = default(Guid), decimal legacyId = default(decimal), string slug = default(string), Social social = default(Social), Money totalAmountRaised = default(Money), string url = default(string), string username = default(string))
        {
            // to ensure "avatar" is required (not null)
            if (avatar == null)
            {
                throw new ArgumentNullException("avatar is a required property for CampaignUser and cannot be null");
            }
            this.Avatar = avatar;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CampaignUser and cannot be null");
            }
            ...
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for CampaignUser and cannot be null");
            }
            this.Slug = slug;
            // to ensure "social" is required (not null)
            if (social == null)
            {
                throw new ArgumentNullException("social is a required property for CampaignUser and cannot be null");
            }
            this.Social = social;
            // to ensure "totalAmountRaised" is required (not null)
            if (totalAmountRaised == null)
            {
                throw new ArgumentNullException("totalAmountRaised is a required property for CampaignUser and cannot be null");
            }
            this.TotalAmountRaised = totalAmountRaised;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for CampaignUser and cannot be null");
            }
            this.Url = url;
            // to ensure "username" is required (not null)
            if (username == null)
            {
                throw new ArgumentNullException("username is a required property for CampaignUser and cannot be null");
            }
