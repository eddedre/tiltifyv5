...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DonationMatchPaginatedResponse_1")]
    public partial class DonationMatchPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationMatchPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DonationMatchPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationMatchPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public DonationMatchPaginatedResponse1(List<DonationMatch> data = default(List<DonationMatch>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public List<DonationMatch> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DonationMatchPaginatedResponse1 {\n");
