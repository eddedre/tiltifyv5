...
{
    /// <summary>
    /// NullableUserResponse1Data
    /// </summary>
    [JsonConverter(typeof(NullableUserResponse1DataJsonConverter))]
    [DataContract(Name = "NullableUserResponse_1_data")]
    public partial class NullableUserResponse1Data : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableUserResponse1Data" /> class.
        /// </summary>
        public NullableUserResponse1Data()
        {
        ...
        public NullableUserResponse1Data(User actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: User");
                }
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NullableUserResponse1Data {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, NullableUserResponse1Data.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of NullableUserResponse1Data
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of NullableUserResponse1Data</returns>
        public static NullableUserResponse1Data FromJson(string jsonString)
        {
            NullableUserResponse1Data newNullableUserResponse1Data = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newNullableUserResponse1Data;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newNullableUserResponse1Data = new NullableUserResponse1Data(JsonConvert.DeserializeObject<User>(jsonString, NullableUserResponse1Data.SerializerSettings));
                }
                else
                {
                    newNullableUserResponse1Data = new NullableUserResponse1Data(JsonConvert.DeserializeObject<User>(jsonString, NullableUserResponse1Data.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for NullableUserResponse1Data
    /// </summary>
    public class NullableUserResponse1DataJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(NullableUserResponse1Data).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return NullableUserResponse1Data.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
