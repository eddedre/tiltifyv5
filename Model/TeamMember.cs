...
namespace TiltifyV5.Model
{
    ...
    public partial class TeamMember : IValidatableObject
    {
        ...
        /// <param name="insertedAt">When the team member was created (required).</param>
        ...
        /// <param name="roles">A list of the team member&#39;s roles (required).</param>
        /// <param name="updatedAt">When the team member was last updated (required).</param>
        /// <param name="user">user (required).</param>
        public TeamMember(Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), List<Role> roles = default(List<Role>), DateTime updatedAt = default(DateTime), User user = default(User))
        {
            this.Id = id;
            ...
            if (roles == null)
            {
                throw new ArgumentNullException("roles is a required property for TeamMember and cannot be null");
            }
            this.Roles = roles;
            ...
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for TeamMember and cannot be null");
            }
            this.User = user;
        }
        ...
        /// </summary>
        /// <value>When the team member was created</value>
        ...
        /// </summary>
        /// <value>A list of the team member&#39;s roles</value>
        ...
        /// </summary>
        /// <value>When the team member was last updated</value>
