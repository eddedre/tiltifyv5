...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardPaginatedResponse")]
    public partial class RewardPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RewardPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public RewardPaginatedResponse(List<Reward> data = default(List<Reward>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RewardPaginatedResponse {\n");
