...
namespace TiltifyV5.Model
{
    ...
    public partial class NotFound : IValidatableObject
    {
        /// <summary>
        ...
        public NotFound(ErrorResponseError error = default(ErrorResponseError))
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for NotFound and cannot be null");
            }
            this.Error = error;
        }
