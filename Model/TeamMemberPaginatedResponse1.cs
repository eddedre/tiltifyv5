...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamMemberPaginatedResponse_1")]
    public partial class TeamMemberPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamMemberPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TeamMemberPaginatedResponse1(List<TeamMember> data = default(List<TeamMember>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamMemberPaginatedResponse1 {\n");
