...
namespace TiltifyV5.Model
{
    ...
    public partial class ErrorResponseError : IValidatableObject
    {
        ...
        /// <param name="message">A human readable message describing the error. (required).</param>
        /// <param name="status">The HTTP status of the error (required).</param>
        public ErrorResponseError(Dictionary<string, List<string>> fields = default(Dictionary<string, List<string>>), string message = default(string), int status = default(int))
        {
        ...
        /// </summary>
        /// <value>A human readable message describing the error.</value>
        ...
        /// </summary>
        /// <value>The HTTP status of the error</value>
