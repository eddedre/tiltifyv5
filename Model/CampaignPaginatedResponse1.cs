...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignPaginatedResponse_1")]
    public partial class CampaignPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CampaignPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public CampaignPaginatedResponse1(List<Campaign> data = default(List<Campaign>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignPaginatedResponse1 {\n");
