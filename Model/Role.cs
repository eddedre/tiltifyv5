...
namespace TiltifyV5.Model
{
    ...
    public partial class Role : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Internal key for the role</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum KeyEnum
        {
            /// <summary>
            /// Enum SuperAdmin for value: team_super_admin
            /// </summary>
            [EnumMember(Value = "team_super_admin")]
            SuperAdmin = 1,

            /// <summary>
            /// Enum Admin for value: team_admin
            /// </summary>
            [EnumMember(Value = "team_admin")]
            Admin = 2,

            /// <summary>
            /// Enum UserManager for value: team_user_manager
            /// </summary>
            [EnumMember(Value = "team_user_manager")]
            UserManager = 3,

            /// <summary>
            /// Enum EventManager for value: team_event_manager
            /// </summary>
            [EnumMember(Value = "team_event_manager")]
            EventManager = 4,

            /// <summary>
            /// Enum Member for value: team_member
            /// </summary>
        ...
        /// <param name="key">Internal key for the role (required).</param>
        /// <param name="name">Visible name of the role (required).</param>
        public Role(Guid id = default(Guid), KeyEnum key = default(KeyEnum), string name = default(string))
        {
            this.Id = id;
            this.Key = key;
        ...
        /// </summary>
        /// <value>Visible name of the role</value>
