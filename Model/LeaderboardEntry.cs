...
namespace TiltifyV5.Model
{
    ...
    public partial class LeaderboardEntry : IValidatableObject
    {
        ...
        /// <param name="heat">The change in place of this entry (required).</param>
        ...
        public LeaderboardEntry(LeaderboardEntryAmount amount = default(LeaderboardEntryAmount), Image avatar = default(Image), decimal? heat = default(decimal?), Guid id = default(Guid), string name = default(string), string url = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for LeaderboardEntry and cannot be null");
            }
            this.Amount = amount;
            // to ensure "avatar" is required (not null)
            if (avatar == null)
            {
                throw new ArgumentNullException("avatar is a required property for LeaderboardEntry and cannot be null");
            }
            this.Avatar = avatar;
            // to ensure "heat" is required (not null)
            if (heat == null)
            {
                throw new ArgumentNullException("heat is a required property for LeaderboardEntry and cannot be null");
            }
            this.Heat = heat;
            this.Id = id;
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for LeaderboardEntry and cannot be null");
            }
            this.Name = name;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for LeaderboardEntry and cannot be null");
            }
            this.Url = url;
        }
        ...
        public LeaderboardEntryAmount Amount { get; set; }
        ...
        /// </summary>
        /// <value>The change in place of this entry</value>
