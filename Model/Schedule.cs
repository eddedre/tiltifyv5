...
namespace TiltifyV5.Model
{
    ...
    public partial class Schedule : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Schedule" /> class.
        /// </summary>
        /// <param name="description">Campaign schedule description (required).</param>
        /// <param name="endsAt">Moment when the schedule ends in ISO8601 format (required).</param>
        /// <param name="id">Unique Identifier for the Object. UUID (required).</param>
        /// <param name="insertedAt">Moment when the milestone was created (required).</param>
        ...
        /// <param name="name">Milestone name (required).</param>
        /// <param name="startsAt">Moment when the schedule starts in ISO8601 format (required).</param>
        /// <param name="updatedAt">Moment when the milestone was last updated (required).</param>
        public Schedule(string description = default(string), DateTime? endsAt = default(DateTime?), Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), string name = default(string), DateTime startsAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            ...
            if (endsAt == null)
            {
                throw new ArgumentNullException("endsAt is a required property for Schedule and cannot be null");
            }
            this.EndsAt = endsAt;
            this.Id = id;
        ...
        /// </summary>
        /// <value>Campaign schedule description</value>
        ...
        /// </summary>
        /// <value>Moment when the schedule ends in ISO8601 format</value>
        ...
        /// </summary>
        /// <value>Moment when the milestone was created</value>
        ...
        /// </summary>
        /// <value>Moment when the schedule starts in ISO8601 format</value>
