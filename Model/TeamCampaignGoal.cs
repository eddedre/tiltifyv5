...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCampaign_goal")]
    public partial class TeamCampaignGoal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignGoal" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamCampaignGoal() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignGoal" /> class.
        /// </summary>
        /// <param name="currency">ISO 4217 alphabetic currency code (required).</param>
        /// <param name="value">Monetary amount (required).</param>
        public TeamCampaignGoal(string currency = default(string), string value = default(string))
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for TeamCampaignGoal and cannot be null");
            }
            this.Currency = currency;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for TeamCampaignGoal and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCampaignGoal {\n");
