...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundraisingEventResponse")]
    public partial class FundraisingEventResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundraisingEventResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FundraisingEventResponse(FundraisingEvent data = default(FundraisingEvent))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FundraisingEventResponse {\n");
