...
namespace TiltifyV5.Model
{
    ...
    public partial class Team : IValidatableObject
    {
        ...
        public Team(Image avatar = default(Image), string description = default(string), Guid id = default(Guid), decimal legacyId = default(decimal), string name = default(string), string slug = default(string), Social social = default(Social), Money totalAmountRaised = default(Money), string url = default(string))
        {
            // to ensure "avatar" is required (not null)
            if (avatar == null)
            {
                throw new ArgumentNullException("avatar is a required property for Team and cannot be null");
            }
            this.Avatar = avatar;
            ...
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for Team and cannot be null");
            }
            this.Slug = slug;
            // to ensure "social" is required (not null)
            if (social == null)
            {
                throw new ArgumentNullException("social is a required property for Team and cannot be null");
            }
            this.Social = social;
            // to ensure "totalAmountRaised" is required (not null)
            if (totalAmountRaised == null)
            {
                throw new ArgumentNullException("totalAmountRaised is a required property for Team and cannot be null");
            }
            this.TotalAmountRaised = totalAmountRaised;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for Team and cannot be null");
            }
            this.Url = url;
        }
