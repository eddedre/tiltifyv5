...
namespace TiltifyV5.Model
{
    ...
    /// CauseResponse1
    /// </summary>
    [DataContract(Name = "CauseResponse_1")]
    public partial class CauseResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CauseResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CauseResponse1(Cause data = default(Cause))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CauseResponse1 {\n");
