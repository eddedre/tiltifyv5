...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCampaign_team")]
    public partial class TeamCampaignTeam : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignTeam" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamCampaignTeam() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignTeam" /> class.
        /// </summary>
        /// <param name="avatar">avatar (required).</param>
        /// <param name="description">The description section on a team&#39;s profile. (required).</param>
        ...
        /// <param name="name">The team&#39;s name (required).</param>
        ...
        public TeamCampaignTeam(Image avatar = default(Image), string description = default(string), Guid id = default(Guid), decimal legacyId = default(decimal), string name = default(string), string slug = default(string), Social social = default(Social), Money totalAmountRaised = default(Money), string url = default(string))
        {
            // to ensure "avatar" is required (not null)
            if (avatar == null)
            {
                throw new ArgumentNullException("avatar is a required property for TeamCampaignTeam and cannot be null");
            }
            this.Avatar = avatar;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for TeamCampaignTeam and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TeamCampaignTeam and cannot be null");
            }
            this.Name = name;
            // to ensure "slug" is required (not null)
            if (slug == null)
            {
                throw new ArgumentNullException("slug is a required property for TeamCampaignTeam and cannot be null");
            }
            this.Slug = slug;
            // to ensure "social" is required (not null)
            if (social == null)
            {
                throw new ArgumentNullException("social is a required property for TeamCampaignTeam and cannot be null");
            }
            this.Social = social;
            // to ensure "totalAmountRaised" is required (not null)
            if (totalAmountRaised == null)
            {
                throw new ArgumentNullException("totalAmountRaised is a required property for TeamCampaignTeam and cannot be null");
            }
            this.TotalAmountRaised = totalAmountRaised;
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new ArgumentNullException("url is a required property for TeamCampaignTeam and cannot be null");
            }
            this.Url = url;
        }
        ...
        /// </summary>
        /// <value>The description section on a team&#39;s profile.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCampaignTeam {\n");
