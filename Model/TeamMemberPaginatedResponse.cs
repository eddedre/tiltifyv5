...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamMemberPaginatedResponse")]
    public partial class TeamMemberPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamMemberPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TeamMemberPaginatedResponse(List<TeamMember> data = default(List<TeamMember>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamMemberPaginatedResponse {\n");
