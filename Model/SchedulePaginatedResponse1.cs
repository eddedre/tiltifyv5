...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SchedulePaginatedResponse_1")]
    public partial class SchedulePaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SchedulePaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public SchedulePaginatedResponse1(List<Schedule> data = default(List<Schedule>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchedulePaginatedResponse1 {\n");
