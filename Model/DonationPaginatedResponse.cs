...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DonationPaginatedResponse")]
    public partial class DonationPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DonationPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public DonationPaginatedResponse(List<Donation> data = default(List<Donation>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DonationPaginatedResponse {\n");
