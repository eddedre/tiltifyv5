...
namespace TiltifyV5.Model
{
    ...
    public partial class PollOption : IValidatableObject
    {
        ...
        /// <param name="insertedAt">Moment when the poll option was created (required).</param>
        ...
        /// <param name="name">poll option name (required).</param>
        /// <param name="updatedAt">Moment when the poll option was last updated (required).</param>
        public PollOption(Money amountRaised = default(Money), Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), string name = default(string), DateTime updatedAt = default(DateTime))
        {
            // to ensure "amountRaised" is required (not null)
            if (amountRaised == null)
            {
                throw new ArgumentNullException("amountRaised is a required property for PollOption and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PollOption and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Moment when the poll option was created</value>
        ...
        /// </summary>
        /// <value>Moment when the poll option was last updated</value>
