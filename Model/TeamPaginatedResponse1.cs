...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamPaginatedResponse_1")]
    public partial class TeamPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TeamPaginatedResponse1(List<Team> data = default(List<Team>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamPaginatedResponse1 {\n");
