...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeaderboardEntryPaginatedResponse")]
    public partial class LeaderboardEntryPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LeaderboardEntryPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public LeaderboardEntryPaginatedResponse(List<LeaderboardEntry> data = default(List<LeaderboardEntry>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardEntryPaginatedResponse {\n");
