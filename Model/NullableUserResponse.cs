...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NullableUserResponse")]
    public partial class NullableUserResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableUserResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public NullableUserResponse(NullableUserResponse1Data data = default(NullableUserResponse1Data))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NullableUserResponse {\n");
