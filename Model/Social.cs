...
namespace TiltifyV5.Model
{
    ...
    public partial class Social : IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="Social" /> class.
        /// </summary>
        /// <param name="discord">Discord invite url (required).</param>
        /// <param name="facebook">Facebook Page username (required).</param>
        /// <param name="instagram">Instagram username (required).</param>
        /// <param name="snapchat">Snapchat username (required).</param>
        /// <param name="tiktok">TikTok username (required).</param>
        /// <param name="twitch">Twitch username (required).</param>
        /// <param name="twitter">Twitter username (required).</param>
        /// <param name="website">Custom website url (required).</param>
        /// <param name="youtube">Youtube channel ID (required).</param>
        public Social(string discord = default(string), string facebook = default(string), string instagram = default(string), string snapchat = default(string), string tiktok = default(string), string twitch = default(string), string twitter = default(string), string website = default(string), string youtube = default(string))
        {
            // to ensure "discord" is required (not null)
            if (discord == null)
            {
                throw new ArgumentNullException("discord is a required property for Social and cannot be null");
            }
            this.Discord = discord;
            // to ensure "facebook" is required (not null)
            if (facebook == null)
            {
                throw new ArgumentNullException("facebook is a required property for Social and cannot be null");
            }
            this.Facebook = facebook;
            // to ensure "instagram" is required (not null)
            if (instagram == null)
            {
                throw new ArgumentNullException("instagram is a required property for Social and cannot be null");
            }
            this.Instagram = instagram;
            // to ensure "snapchat" is required (not null)
            if (snapchat == null)
            {
                throw new ArgumentNullException("snapchat is a required property for Social and cannot be null");
            }
            this.Snapchat = snapchat;
            // to ensure "tiktok" is required (not null)
            if (tiktok == null)
            {
                throw new ArgumentNullException("tiktok is a required property for Social and cannot be null");
            }
            this.Tiktok = tiktok;
            // to ensure "twitch" is required (not null)
            if (twitch == null)
            {
                throw new ArgumentNullException("twitch is a required property for Social and cannot be null");
            }
            this.Twitch = twitch;
            // to ensure "twitter" is required (not null)
            if (twitter == null)
            {
                throw new ArgumentNullException("twitter is a required property for Social and cannot be null");
            }
            this.Twitter = twitter;
            // to ensure "website" is required (not null)
            if (website == null)
            {
                throw new ArgumentNullException("website is a required property for Social and cannot be null");
            }
            this.Website = website;
            // to ensure "youtube" is required (not null)
            if (youtube == null)
            {
                throw new ArgumentNullException("youtube is a required property for Social and cannot be null");
            }
        ...
        /// Discord invite url
        /// </summary>
        /// <value>Discord invite url</value>
        ...
        /// </summary>
        /// <value>Facebook Page username</value>
        [DataMember(Name = "facebook", IsRequired = true, EmitDefaultValue = true)]
        public string Facebook { get; set; }

        /// <summary>
        /// Instagram username
        /// </summary>
        /// <value>Instagram username</value>
        ...
        /// Snapchat username
        /// </summary>
        /// <value>Snapchat username</value>
        [DataMember(Name = "snapchat", IsRequired = true, EmitDefaultValue = true)]
        public string Snapchat { get; set; }

        /// <summary>
        /// TikTok username
        /// </summary>
        /// <value>TikTok username</value>
        ...
        [DataMember(Name = "twitch", IsRequired = true, EmitDefaultValue = true)]
        public string Twitch { get; set; }

        /// <summary>
        /// Twitter username
        /// </summary>
        /// <value>Twitter username</value>
        ...
        /// Custom website url
        /// </summary>
        /// <value>Custom website url</value>
        ...
        /// Youtube channel ID
        /// </summary>
        /// <value>Youtube channel ID</value>
        [DataMember(Name = "youtube", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Twitch: ").Append(Twitch).Append("\n");
