...
namespace TiltifyV5.Model
{
    ...
    /// PollResponse1
    /// </summary>
    [DataContract(Name = "PollResponse_1")]
    public partial class PollResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PollResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PollResponse1(Poll data = default(Poll))
        {
            this.Data = data;
        }
