...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MilestonePaginatedResponse_1")]
    public partial class MilestonePaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilestonePaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MilestonePaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MilestonePaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public MilestonePaginatedResponse1(List<Milestone> data = default(List<Milestone>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilestonePaginatedResponse1 {\n");
