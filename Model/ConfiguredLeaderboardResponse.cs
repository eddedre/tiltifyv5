...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConfiguredLeaderboardResponse")]
    public partial class ConfiguredLeaderboardResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfiguredLeaderboardResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ConfiguredLeaderboardResponse(ConfiguredLeaderboard data = default(ConfiguredLeaderboard))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfiguredLeaderboardResponse {\n");
