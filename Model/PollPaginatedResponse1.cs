...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PollPaginatedResponse_1")]
    public partial class PollPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PollPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PollPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PollPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public PollPaginatedResponse1(List<Poll> data = default(List<Poll>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PollPaginatedResponse1 {\n");
