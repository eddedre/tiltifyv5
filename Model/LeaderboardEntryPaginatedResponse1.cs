...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeaderboardEntryPaginatedResponse_1")]
    public partial class LeaderboardEntryPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LeaderboardEntryPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public LeaderboardEntryPaginatedResponse1(List<LeaderboardEntry> data = default(List<LeaderboardEntry>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardEntryPaginatedResponse1 {\n");
