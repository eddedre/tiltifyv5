...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EventPaginatedResponse_1")]
    public partial class EventPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EventPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EventPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public EventPaginatedResponse1(List<Event> data = default(List<Event>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventPaginatedResponse1 {\n");
