...
namespace TiltifyV5.Model
{
    ...
    /// LegacyRelay
    /// </summary>
    [DataContract(Name = "LegacyRelay")]
    public partial class LegacyRelay : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyRelay" /> class.
        /// </summary>
        /// <param name="amount">Monetary amount.</param>
        /// <param name="anonymous">Wether the donation is anonymous or not.</param>
        /// <param name="currencyCode">Monetary amount.</param>
        /// <param name="donorComment">The donors Comment.</param>
        /// <param name="donorName">The donors name.</param>
        /// <param name="meta">meta.</param>
        /// <param name="paymentStatus">The status of the donation.</param>
        /// <param name="uuid">The providers UUID.</param>
        public LegacyRelay(string amount = default(string), bool anonymous = default(bool), string currencyCode = default(string), string donorComment = default(string), string donorName = default(string), LegacyRelayMeta meta = default(LegacyRelayMeta), string paymentStatus = default(string), string uuid = default(string))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>Wether the donation is anonymous or not</value>
        ...
        /// The donors Comment
        /// </summary>
        /// <value>The donors Comment</value>
        [DataMember(Name = "donor_comment", EmitDefaultValue = false)]
        public string DonorComment { get; set; }

        /// <summary>
        /// The donors name
        /// </summary>
        /// <value>The donors name</value>
        [DataMember(Name = "donor_name", EmitDefaultValue = false)]
        ...
        public LegacyRelayMeta Meta { get; set; }

        /// <summary>
        /// The status of the donation
        /// </summary>
        /// <value>The status of the donation</value>
        ...
        /// The providers UUID
        /// </summary>
        /// <value>The providers UUID</value>
