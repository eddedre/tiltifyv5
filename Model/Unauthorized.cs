...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Unauthorized")]
    public partial class Unauthorized : IValidatableObject
    {
        /// <summary>
        ...
        public Unauthorized(ErrorResponseError error = default(ErrorResponseError))
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for Unauthorized and cannot be null");
            }
            this.Error = error;
        }
