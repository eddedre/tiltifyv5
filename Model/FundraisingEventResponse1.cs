...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundraisingEventResponse_1")]
    public partial class FundraisingEventResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundraisingEventResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FundraisingEventResponse1(FundraisingEvent data = default(FundraisingEvent))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FundraisingEventResponse1 {\n");
