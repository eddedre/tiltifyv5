...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCampaignResponse_1")]
    public partial class TeamCampaignResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCampaignResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TeamCampaignResponse1(TeamCampaign data = default(TeamCampaign))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCampaignResponse1 {\n");
