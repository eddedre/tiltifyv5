...
namespace TiltifyV5.Model
{
    ...
    /// LegacyRelayResponse
    /// </summary>
    [DataContract(Name = "LegacyRelayResponse")]
    public partial class LegacyRelayResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyRelayResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public LegacyRelayResponse(LegacyRelay data = default(LegacyRelay))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LegacyRelayResponse {\n");
