...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DonationPaginatedResponse_1")]
    public partial class DonationPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DonationPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DonationPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public DonationPaginatedResponse1(List<Donation> data = default(List<Donation>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DonationPaginatedResponse1 {\n");
