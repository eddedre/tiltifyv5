...
namespace TiltifyV5.Model
{
    ...
    /// UserResponse1
    /// </summary>
    [DataContract(Name = "UserResponse_1")]
    public partial class UserResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public UserResponse1(User data = default(User))
        {
            this.Data = data;
        }
