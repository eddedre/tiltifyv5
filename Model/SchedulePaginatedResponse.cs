...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SchedulePaginatedResponse")]
    public partial class SchedulePaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SchedulePaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public SchedulePaginatedResponse(List<Schedule> data = default(List<Schedule>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchedulePaginatedResponse {\n");
