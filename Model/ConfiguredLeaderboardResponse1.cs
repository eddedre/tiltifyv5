...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConfiguredLeaderboardResponse_1")]
    public partial class ConfiguredLeaderboardResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfiguredLeaderboardResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ConfiguredLeaderboardResponse1(ConfiguredLeaderboard data = default(ConfiguredLeaderboard))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfiguredLeaderboardResponse1 {\n");
