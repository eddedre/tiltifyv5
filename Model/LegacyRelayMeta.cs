...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(LegacyRelayMetaJsonConverter))]
    [DataContract(Name = "LegacyRelay_meta")]
    public partial class LegacyRelayMeta : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyRelayMeta" /> class
        /// with the <see cref="string" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of string.</param>
        public LegacyRelayMeta(string actualInstance)
        {
        ...
        public LegacyRelayMeta(Object actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LegacyRelayMeta {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, LegacyRelayMeta.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of LegacyRelayMeta
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of LegacyRelayMeta</returns>
        public static LegacyRelayMeta FromJson(string jsonString)
        {
            LegacyRelayMeta newLegacyRelayMeta = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newLegacyRelayMeta;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newLegacyRelayMeta = new LegacyRelayMeta(JsonConvert.DeserializeObject<Object>(jsonString, LegacyRelayMeta.SerializerSettings));
                }
                else
                {
                    newLegacyRelayMeta = new LegacyRelayMeta(JsonConvert.DeserializeObject<Object>(jsonString, LegacyRelayMeta.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newLegacyRelayMeta = new LegacyRelayMeta(JsonConvert.DeserializeObject<string>(jsonString, LegacyRelayMeta.SerializerSettings));
                }
                else
                {
                    newLegacyRelayMeta = new LegacyRelayMeta(JsonConvert.DeserializeObject<string>(jsonString, LegacyRelayMeta.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for LegacyRelayMeta
    /// </summary>
    public class LegacyRelayMetaJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(LegacyRelayMeta).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return LegacyRelayMeta.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
