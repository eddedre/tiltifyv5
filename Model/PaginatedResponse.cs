...
namespace TiltifyV5.Model
{
    ...
    public partial class PaginatedResponse : IValidatableObject
    {
        ...
        public PaginatedResponse(List<Object> data = default(List<Object>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
