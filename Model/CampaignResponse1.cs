...
namespace TiltifyV5.Model
{
    ...
    /// CampaignResponse1
    /// </summary>
    [DataContract(Name = "CampaignResponse_1")]
    public partial class CampaignResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CampaignResponse1(Campaign data = default(Campaign))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignResponse1 {\n");
