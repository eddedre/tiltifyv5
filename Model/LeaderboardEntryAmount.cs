...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(LeaderboardEntryAmountJsonConverter))]
    [DataContract(Name = "LeaderboardEntry_amount")]
    public partial class LeaderboardEntryAmount : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryAmount" /> class
        /// with the <see cref="Money" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Money.</param>
        public LeaderboardEntryAmount(Money actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LeaderboardEntryAmount" /> class
        /// with the <see cref="MeasuredUnit" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of MeasuredUnit.</param>
        public LeaderboardEntryAmount(MeasuredUnit actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(MeasuredUnit))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: MeasuredUnit, Money");
                }
            }
        }
        ...
        /// </summary>
        /// <returns>An instance of Money</returns>
        public Money GetMoney()
        {
            return (Money)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `MeasuredUnit`. If the actual instance is not `MeasuredUnit`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of MeasuredUnit</returns>
        public MeasuredUnit GetMeasuredUnit()
        {
            return (MeasuredUnit)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeaderboardEntryAmount {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, LeaderboardEntryAmount.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of LeaderboardEntryAmount
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of LeaderboardEntryAmount</returns>
        public static LeaderboardEntryAmount FromJson(string jsonString)
        {
            LeaderboardEntryAmount newLeaderboardEntryAmount = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newLeaderboardEntryAmount;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(MeasuredUnit).GetProperty("AdditionalProperties") == null)
                {
                    newLeaderboardEntryAmount = new LeaderboardEntryAmount(JsonConvert.DeserializeObject<MeasuredUnit>(jsonString, LeaderboardEntryAmount.SerializerSettings));
                }
                else
                {
                    newLeaderboardEntryAmount = new LeaderboardEntryAmount(JsonConvert.DeserializeObject<MeasuredUnit>(jsonString, LeaderboardEntryAmount.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("MeasuredUnit");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into MeasuredUnit: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(Money).GetProperty("AdditionalProperties") == null)
                {
                    newLeaderboardEntryAmount = new LeaderboardEntryAmount(JsonConvert.DeserializeObject<Money>(jsonString, LeaderboardEntryAmount.SerializerSettings));
                }
                else
                {
                    newLeaderboardEntryAmount = new LeaderboardEntryAmount(JsonConvert.DeserializeObject<Money>(jsonString, LeaderboardEntryAmount.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Money");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Money: {1}", jsonString, exception.ToString()));
            }
    ...
    /// <summary>
    /// Custom JSON converter for LeaderboardEntryAmount
    /// </summary>
    public class LeaderboardEntryAmountJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(LeaderboardEntryAmount).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return LeaderboardEntryAmount.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
