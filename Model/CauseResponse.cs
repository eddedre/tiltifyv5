...
namespace TiltifyV5.Model
{
    ...
    /// CauseResponse
    /// </summary>
    [DataContract(Name = "CauseResponse")]
    public partial class CauseResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CauseResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CauseResponse(Cause data = default(Cause))
        {
            this.Data = data;
        }
