...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LegacyRelayResponse_1")]
    public partial class LegacyRelayResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyRelayResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public LegacyRelayResponse1(LegacyRelay data = default(LegacyRelay))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LegacyRelayResponse1 {\n");
