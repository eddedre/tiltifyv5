...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardPaginatedResponse_1")]
    public partial class RewardPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RewardPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public RewardPaginatedResponse1(List<Reward> data = default(List<Reward>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RewardPaginatedResponse1 {\n");
