...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NullableUserResponse_1")]
    public partial class NullableUserResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableUserResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public NullableUserResponse1(NullableUserResponse1Data data = default(NullableUserResponse1Data))
        {
            this.Data = data;
        }
        ...
        public NullableUserResponse1Data Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NullableUserResponse1 {\n");
