...
namespace TiltifyV5.Model
{
    ...
    public partial class Poll : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Poll" /> class.
        /// </summary>
        /// <param name="active">Whether or not the poll is active (required).</param>
        /// <param name="amountRaised">amountRaised (required).</param>
        /// <param name="id">Unique Identifier for the Object. UUID (required).</param>
        /// <param name="insertedAt">Moment when the poll was created (required).</param>
        ...
        /// <param name="name">Poll name (required).</param>
        /// <param name="options">options (required).</param>
        /// <param name="updatedAt">Moment when the poll was last updated (required).</param>
        public Poll(bool? active = default(bool?), Money amountRaised = default(Money), Guid id = default(Guid), DateTime insertedAt = default(DateTime), decimal legacyId = default(decimal), string name = default(string), List<PollOption> options = default(List<PollOption>), DateTime updatedAt = default(DateTime))
        {
            // to ensure "active" is required (not null)
            if (active == null)
            {
                throw new ArgumentNullException("active is a required property for Poll and cannot be null");
            }
            this.Active = active;
            // to ensure "amountRaised" is required (not null)
            if (amountRaised == null)
            {
                throw new ArgumentNullException("amountRaised is a required property for Poll and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Poll and cannot be null");
            }
            this.Name = name;
            // to ensure "options" is required (not null)
            if (options == null)
            {
                throw new ArgumentNullException("options is a required property for Poll and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Whether or not the poll is active</value>
        ...
        /// </summary>
        /// <value>Moment when the poll was created</value>
        ...
        /// </summary>
        /// <value>Moment when the poll was last updated</value>
