...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RewardClaim")]
    public partial class RewardClaim : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RewardClaim" /> class.
        /// </summary>
        /// <param name="id">Public ID for the reward claim.</param>
        /// <param name="quantity">Quantity claimed.</param>
        /// <param name="rewardId">Public ID for the reward.</param>
        public RewardClaim(string id = default(string), int quantity = default(int), string rewardId = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Public ID for the reward claim</value>
        ...
        /// </summary>
        /// <value>Public ID for the reward</value>
        [DataMember(Name = "reward_id", EmitDefaultValue = false)]
