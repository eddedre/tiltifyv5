...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Forbidden")]
    public partial class Forbidden : IValidatableObject
    {
        /// <summary>
        ...
        public Forbidden(ErrorResponseError error = default(ErrorResponseError))
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for Forbidden and cannot be null");
            }
            this.Error = error;
        }
