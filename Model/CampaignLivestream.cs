...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Campaign_livestream")]
    public partial class CampaignLivestream : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignLivestream" /> class.
        /// </summary>
        /// <param name="channel">The channel name for the livestream.</param>
        /// <param name="type">The type of livestream.</param>
        public CampaignLivestream(string channel = default(string), string type = default(string))
        {
        ...
        /// </summary>
        /// <value>The channel name for the livestream</value>
        ...
        /// </summary>
        /// <value>The type of livestream</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignLivestream {\n");
