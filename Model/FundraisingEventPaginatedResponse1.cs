...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundraisingEventPaginatedResponse_1")]
    public partial class FundraisingEventPaginatedResponse1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundraisingEventPaginatedResponse1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FundraisingEventPaginatedResponse1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FundraisingEventPaginatedResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public FundraisingEventPaginatedResponse1(List<FundraisingEvent> data = default(List<FundraisingEvent>), LeaderboardEntryPaginatedResponse1Metadata metadata = default(LeaderboardEntryPaginatedResponse1Metadata))
        {
            this.Data = data;
        ...
        public List<FundraisingEvent> Data { get; set; }

        /// <summary>
        /// Gets or Sets Metadata
        /// </summary>
        [DataMember(Name = "metadata", EmitDefaultValue = false)]
        public LeaderboardEntryPaginatedResponse1Metadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FundraisingEventPaginatedResponse1 {\n");
