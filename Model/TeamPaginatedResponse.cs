...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamPaginatedResponse")]
    public partial class TeamPaginatedResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamPaginatedResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamPaginatedResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamPaginatedResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="metadata">metadata.</param>
        public TeamPaginatedResponse(List<Team> data = default(List<Team>), Object metadata = default(Object))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamPaginatedResponse {\n");
