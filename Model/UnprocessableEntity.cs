...
namespace TiltifyV5.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnprocessableEntity")]
    public partial class UnprocessableEntity : IValidatableObject
    {
        ...
        public UnprocessableEntity(ErrorResponseError error = default(ErrorResponseError))
        {
            // to ensure "error" is required (not null)
            if (error == null)
            {
                throw new ArgumentNullException("error is a required property for UnprocessableEntity and cannot be null");
            }
            this.Error = error;
        }
