...
namespace TiltifyV5.Model
{
    ...
    public partial class Event : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        /// with the <see cref="Campaign" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Campaign.</param>
        public Event(Campaign actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Event" /> class
        /// with the <see cref="TeamCampaign" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of TeamCampaign.</param>
        public Event(TeamCampaign actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(Campaign))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(TeamCampaign))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: Campaign, TeamCampaign");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `Campaign`. If the actual instance is not `Campaign`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Campaign</returns>
        public Campaign GetCampaign()
        {
            return (Campaign)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `TeamCampaign`. If the actual instance is not `TeamCampaign`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of TeamCampaign</returns>
        public TeamCampaign GetTeamCampaign()
        {
            return (TeamCampaign)this.ActualInstance;
        }
        ...
        public static Event FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                if (typeof(Campaign).GetProperty("AdditionalProperties") == null)
                {
                    newEvent = new Event(JsonConvert.DeserializeObject<Campaign>(jsonString, Event.SerializerSettings));
                }
                else
                {
                    newEvent = new Event(JsonConvert.DeserializeObject<Campaign>(jsonString, Event.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("Campaign");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Campaign: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(TeamCampaign).GetProperty("AdditionalProperties") == null)
                {
                    newEvent = new Event(JsonConvert.DeserializeObject<TeamCampaign>(jsonString, Event.SerializerSettings));
                }
                else
                {
                    newEvent = new Event(JsonConvert.DeserializeObject<TeamCampaign>(jsonString, Event.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("TeamCampaign");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into TeamCampaign: {1}", jsonString, exception.ToString()));
            }
